...
const AdminCRUD = () => {
    ...
    const departmentOptions = [
        "Cardiology", "Pediatrics", "Surgery", "Emergency", "Radiology", 
        "Neurology", "Orthopedics", "Oncology", "Dermatology", "Psychiatry", "Administration"
    ]

    // Specialization options
    const doctorSpecializations = [
        "Cardiologist", "Pediatrician", "Surgeon", "Emergency Physician", "Radiologist",
        "Neurologist", "Orthopedic Surgeon", "Oncologist", "Dermatologist", "Psychiatrist", "General Practitioner"
    ]

    const assistantSpecializations = [
        "Medical Assistant", "Nurse Assistant", "Surgical Assistant",
        "Administrative Assistant", "Laboratory Assistant", "Radiology Assistant"
    ]
    ...
    const handleSubmit = (e) => {
        ...
        let specialization = newUser.specialization;
        if (!specialization) {
    ...
    return (
        <Fragment>
            ...
            <Container fluid className="app-header admin-header">
                <div className="header-content">
                    ...
                    <div className="user-info">
                        ...
                        <span className="user-role badge bg-warning text-dark ms-2">{user?.role}</span>
                        <button 
            ...
            <Container>
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p className="text-muted">Manage Doctors, Assistants, and Administrative Staff</p>
                    </div>
                    <button 
                ...
                <Table striped bordered hover responsive>
                    ...
                    <tbody>
                        {data && data.length > 0 ?
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <span className={`badge ${
                                                ...
                                                item.role === 'Doctor' ? 'bg-primary' : 
                                                item.role === 'Assistant' ? 'bg-success' : 
                                                'bg-secondary'
                                            }`}>
                                                {item.role}
                                            </span>
                            ...
                            :
                            <tr>
                                <td colSpan="10" className="text-center">Loading staff data...</td>
                            </tr>
                        }
                    </tbody>
                </Table>
